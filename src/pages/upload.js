        ...
        <Grid container spacing={3} align="center" justify="center">
          <Grid item xs={12}>
            ...
            <Typography variant="body1">
              ...
              <br />
              We kindly ask you to also support the contact tracing effort by
              uploading location data, which will anonymously inform others of
              where contagion is spreading.
            </Typography>
          </Grid>
          <Grid item xs={12}>
            {token ? (
